  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <h1>Buah Batu Regency</h1>
      </a>

      <nav id="navbar" class="navbar">
        <ul>
          <li class="dropdown"><a href="category.html"><span>Fasilitas</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
              <li class="dropdown"><a href="#"><span>Masjid Abdurrahman</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
                <ul>
                  <li><a href="#">Jadwal Shalat</a></li>
                  <li><a href="#">Pengumuman DKM</a></li>
                  <li><a href="#">Jadwal Shalat</a></li>
                  <li><a href="#">Layanan Masjid</a></li>
          ...
          <li class="dropdown"><a href="#"><span>Informasi</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
              <li><a href="#">Informasi Warga</a></li>
              <li><a href="#">Informasi Pemkot</a></li>
            </ul>
          </li>
